...
## 📖 Documentation
See the Jupyter Notebook or Markdown files in the [`docs`](https://github.com/weber1158/eds-classification.jl/tree/main/docs) folder for a short tutorial on how to use the software.
